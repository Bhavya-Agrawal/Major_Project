...
commands.getoutput('sudo virt-install --name {} --ram {} --vcpu {} --disk path=/var/lib/libvirt/images/window32.qcow2 --import --noautoconsole '.format(os_name,os_ram,os_cpu,os_name))
	#print install	
#else :
 #print "hello"
