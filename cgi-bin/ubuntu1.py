...
commands.getoutput('sudo virt-install --name {} --ram {} --vcpu {} --nodisk --cdrom  /root/Downloads/ubuntu-16.04-desktop-amd64.iso  --graphics vnc'.format(os_name,os_ram,os_cpu,os_name))
	#print install	
#else :
 #print "hello"
