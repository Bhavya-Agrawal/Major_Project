...
commands.getoutput('sudo virt-install --name {} --ram {} --vcpu {} --nodisk --cdrom  /root/Downloads/kali-linux-2.0-amd64.iso  --graphics vnc'.format(os_name,os_ram,os_cpu,os_name))
	#print install	
#else :
 #print "hello"
