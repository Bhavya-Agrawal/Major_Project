...
commands.getoutput('sudo virt-install --name {} --ram {} --vcpu {} --nodisk --cdrom  /root/Downloads/CentOS_6.4_64-bin.iso  --graphics vnc'.format(os_name,os_ram,os_cpu,os_name))
	#print install	
#else :
 #print "hello"
